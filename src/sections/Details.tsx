...
function MobileDetails() {
  ...
  const goTo = (i: number) => setActive(Math.max(0, Math.min(CARDS.length - 1, i)));
  ...
  return (
    ...
    <div ref={sectionRef} className="relative w-full flex flex-col overflow-hidden">
      ...
      >
        <p
          ...
          style={{ ...coconat, fontSize: '16px', letterSpacing: '0.15em', lineHeight: '1.05', fontWeight: 400 }}
        >
          Partenariats
        </p>
        ...
        <h2
          ...
          style={{ ...coconat, fontSize: 'clamp(26px, 7vw, 26px)', lineHeight: '1.1', letterSpacing: '-0.02em' }}
        >
          Construire{' '}
        ...
        >
          ...
          Nous travaillons avec des partenaires publics et privés pour concevoir, financer,
          développer et exploiter des projets structurants en RDC. Forte d'une expertise
          intégrée sur l'ensemble du cycle de projet, la SEDIC est votre interlocuteur
          privilégié pour développer des opportunités durables et créatrices de valeur.
        </p>
      </div>
        ...
        <div className="relative w-full" style={{ height: '320px' }}>
          {CARDS.map((card, i) => {
            ...
            return (
              ...
              >
                <img src={card.icon} alt="" style={{ width: '60px', height: '60px', objectFit: 'contain', marginBottom: '16px' }} />
                <p
                  style={{
                    ...coconat,
                    fontSize: '13px',
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ background: 'linear-gradient(to bottom, rgba(200,215,235,0.45) 0%, transparent 45%)' }}
      />
      ...
      >
        <h2 className="mb-8" style={{ lineHeight: 1 }}>
          <em style={{ fontFamily: "'Charis SIL', Georgia, serif", fontStyle: 'italic', fontWeight: 700, fontSize: '38px', lineHeight: 1, letterSpacing: '-0.02em', color: '#ffffff', display: 'block' }}>
            Nous recherchons
          </em>
          <span style={{ ...coconat, fontStyle: 'normal', fontWeight: 400, fontSize: '38px', lineHeight: 1, letterSpacing: '-0.02em', color: '#ffffff', display: 'block' }}>
        ...
        <div className="grid grid-cols-3 gap-5 w-full pb-20 px-8">
          {CARDS.map((card) => (
            ...
            >
              <img src={card.icon} alt="" className="mb-5 select-none" style={{ width: '70px', height: '70px', objectFit: 'contain' }} />
              <p style={{ ...coconat, fontSize: '20.5px', fontWeight: 400, letterSpacing: '0.02em', lineHeight: '1.05', color: '#ffffff', whiteSpace: 'pre-line', textTransform: 'uppercase' }}>
                {card.label}
              </p>
            </div>
          ))}
