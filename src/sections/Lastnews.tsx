...
function MobileLastnews() {
  ...
  return (
    <section className="w-full flex flex-col" style={{ backgroundColor: "#efeeeb" }}>
      ...
      >
        ...
        <div className="px-5 pt-5 pb-6 flex flex-col gap-4">
          ...
          >
            <span style={{ ...coconat, color: "white", fontSize: "16px", letterSpacing: "0.10em" }}>
              {displayedNews.label}
            </span>
          </div>
          ...
          <div style={{ position: "relative" }}>
            ...
            <div
              style={{
                ...
                height: "52px",
                pointerEvents: "none",
                background: "linear-gradient(to bottom, rgba(239,238,235,0) 0%, rgba(239,238,235,1) 100%)",
              }}
            />
          </div>
        </div>
              ...
              >
                ...
                <div
                  style={{
                    overflow: "hidden",
                    marginBottom: "8px",
                    borderBottom: active ? "3px solid #223078" : "3px solid transparent",
...
function DesktopLastnews() {
  ...
  return (
    <section className="w-full" style={{ backgroundColor: "#efeeeb" }}>
      ...
      >
        <h2 style={{ ...coconat, color: "white", fontSize: "20px", letterSpacing: "0.04em" }}>
      ...
      <div className="grid" style={{ gridTemplateColumns: "1fr 1fr", minHeight: "610px" }}>
        ...
        >
          <div style={{ maxWidth: "620px", height: "100%", display: "flex", flexDirection: "column" }}>
            ...
            <h3 style={{ ...coconat, color: "#223078", fontSize: "38px", lineHeight: "1.05", marginBottom: "42px", fontWeight: 400 }}>
              {selectedNews.title}
            </h3>
            <div style={{ position: "relative", flex: 1, overflow: "hidden" }}>
              <div style={{ height: "100%", overflowY: "auto", paddingRight: "12px", scrollbarWidth: "none" }} className="hide-scrollbar">
                <p style={{ ...commissioner, color: "#1e1e1e", fontSize: "15px", lineHeight: "1.7", whiteSpace: "pre-line", margin: 0, paddingBottom: "80px" }}>
                  {selectedNews.description}
                </p>
              </div>
              <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, height: "90px", pointerEvents: "none", background: "linear-gradient(to bottom, rgba(239,238,235,0) 0%, rgba(239,238,235,0.75) 45%, rgba(239,238,235,1) 100%)" }} />
            </div>
          </div>
        </div>
      ...
      <div style={{ backgroundColor: "white", padding: "18px", position: "relative" }}>
        <button onClick={() => document.getElementById("news-scroll")?.scrollBy({ left: -300, behavior: "smooth" })}
          style={{ position: "absolute", left: "0", top: "40%", transform: "translateY(-50%)", zIndex: 10, backgroundColor: "#223078", color: "white", border: "none", width: "40px", height: "60px", cursor: "pointer", fontSize: "18px", display: "flex", alignItems: "center", justifyContent: "center" }}>‹</button>
        <button onClick={() => document.getElementById("news-scroll")?.scrollBy({ left: 300, behavior: "smooth" })}
          style={{ position: "absolute", right: "0", top: "40%", transform: "translateY(-50%)", zIndex: 10, backgroundColor: "#223078", color: "white", border: "none", width: "40px", height: "60px", cursor: "pointer", fontSize: "18px", display: "flex", alignItems: "center", justifyContent: "center" }}>›</button>
        <div id="news-scroll" style={{ display: "flex", gap: "18px", overflowX: "auto", scrollbarWidth: "none", msOverflowStyle: "none", padding: "0 48px" }} className="hide-scrollbar">
          {NEWS.map((news) => {
            const active = selectedNews.id === news.id;
            return (
              <button key={news.id} onClick={() => selectNews(news)}
                ...
                <div style={{ minHeight: "52px", display: "flex", alignItems: "flex-start", justifyContent: "center", padding: "0 8px" }}>
                  <p style={{ ...commissioner, color: "#223078", fontSize: "15px", fontWeight: active ? 700 : 600, lineHeight: "1.35", maxWidth: "280px", margin: 0, textAlign: "center" }}>
                    {news.title}
                  </p>
                </div>
              </button>
      ...
      <div className="flex flex-col items-center text-center bg-white px-20 py-16">
        <p className="uppercase text-[#1e2d6b] mb-5" style={{ ...coconat, fontSize: "20.5px", letterSpacing: "0.02em", lineHeight: "1.05", fontWeight: 400 }}>
          restez informés
        </p>
