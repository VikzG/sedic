    ...
    >
      ...
      <div className="relative w-1/2" style={{ height: '1000px' }}>
        ...
        <div
          ...
          style={{
            backgroundImage: 'url(https://res.cloudinary.com/dynpasxkm/image/upload/f_auto/v1780405130/bg_partenaires_gvl5u8.webp)',
      ...
      <div className="w-1/2 flex flex-col px-16 py-24">
        ...
        <div className="flex-1 flex flex-col items-center justify-center">
          ...
          >
            ...
            <br/>
Nous collaborons avec des partenaires à la fois publics et privés afin de concevoir, financer, développer
et gérer des projets ambitieux en République du Congo.
<br/>
Chaque partenariat est basé sur la confiance, la transparence et une vision commune du développement.
          </p>
        </div>
      </div>
    </section>
